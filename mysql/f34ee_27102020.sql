...
INSERT INTO `menu` (`id`, `dish_name`, `price`, `cat_id`, `description`, `available`) VALUES
...
(3, 'Strawberry Shortcake', 38.00, 1, 'Classic vanilla cake filled with strawberry cream and topped with fresh strawberries', 1),
...
INSERT INTO `order` (`id`, `customer_id`, `amount`, `date`, `status`) VALUES
(1, 1, 15.00, '2020-10-23 03:49:33', 0),
(2, 1, 15.00, '2020-10-23 03:50:29', 0),
(7, 1, 67.50, '2020-10-23 04:19:14', 0);
...
(2, 'test@test.com', 'Testing Name two', 42345678, 0, '$2y$10$UMDKymZcMKqj7cEvCqNEGuUh0C.3e4Nji6sYOQpf1uKjGHKaPfm9i');
